...
describe('CU04-AfficherDevoir', () => {
    ...
    it('should see items from the list', async () => {
        const res = await chai.request(app).get('/Devoir/Voir/demarrer/');
    ...
    it('should see items from the list', async () => {
        /*
        const res = await chai.request(app).get('/Devoir/Voir/choisirQuestionnaire/1?idCours=1');
